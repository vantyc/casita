    ...
    public class RetencionesLocales
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((_serializer == null))
                {
                    _serializer = new XmlSerializerFactory().CreateSerializer(typeof(RetencionesLocales));
                }
                return _serializer;
            }
        }
        ...
        public static bool Deserialize(string input, out RetencionesLocales obj, out Exception exception)
        {
            exception = null;
            obj = default(RetencionesLocales);
            try
            {
        ...
        public static bool Deserialize(string input, out RetencionesLocales obj)
        {
            Exception exception;
            return Deserialize(input, out obj, out exception);
        }

        public static RetencionesLocales Deserialize(string input)
        {
            StringReader stringReader = null;
            try
            {
                stringReader = new StringReader(input);
                return ((RetencionesLocales)(Serializer.Deserialize(XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        public static RetencionesLocales Deserialize(Stream s)
        {
            return ((RetencionesLocales)(Serializer.Deserialize(s)));
        }
        #endregion
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, Encoding encoding, out RetencionesLocales obj, out Exception exception)
        {
            exception = null;
            obj = default(RetencionesLocales);
            try
        ...
        public static bool LoadFromFile(string fileName, out RetencionesLocales obj, out Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out RetencionesLocales obj)
        {
            Exception exception;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static RetencionesLocales LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static RetencionesLocales LoadFromFile(string fileName, Encoding encoding)
        {
